            ...
            switch (resultCount) {
                ...
                default:
                    this.dom.results.innerHTML =
                        "找到找到找到&nbsp;" + resultCount + "&nbsp;个节点nbsp;" + resultCount + "找到&nbsp;" + resultCount + "&nbsp;个节点nbsp;個節點nbsp;" + resultCount + "找到找到&nbsp;" + resultCount + "&nbsp;个节点nbsp;" + resultCount + "找到&nbsp;" + resultCount + "&nbsp;个节点nbsp;個節點nbsp;個節點";
                    break;
            }
        } else {
            this.dom.results.innerHTML = "";
