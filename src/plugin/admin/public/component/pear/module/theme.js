layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function(color, second) {
		...
		style += '.layui-laydate .layui-this, .layui-laydate .layui-this div{background-color:'+color+'!important}';//變更
		style += 'xm-select .xm-label .xm-label-block{background-color:'+color+'!important}';//變更
		style += 'xm-select{border-color:#EEE !important}';//變更
		style += 'xm-select .xm-body .xm-option.selected .xm-option-icon{border-color:'+color+'!important;color:'+color+'!important;}';//變更
		style += 'xm-select .xm-body .xm-option .xm-option-icon{border-color:'+color+'!important;}';//變更
		style += 'xm-select > .xm-body .xm-option.selected.hide-icon{background-color:'+color+'!important;}';//變更
		style += 'xm-select > .xm-body .xm-toolbar .toolbar-tag:hover{color:'+color+'!important;}';//變更
		style += '.layui-layer-dialog .layui-layer-content .layui-icon-ok{color:'+color+'!important;}';//變更
		style += '.layui-layer-dialog .layui-layer-content .layui-icon-ok{color:'+color+'!important;}';//變更
		style += 'a{color:'+color+';opacity:.8}';//變更
		style += 'a:hover{color:'+color+';opacity:1}';//變更
